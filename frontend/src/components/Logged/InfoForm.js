            ...
            <div>
                <form onSubmit={this.infoSubmit} autoComplete="off">
                    <div className="form-group">
                        <label className="Heading">Contact Name:</label><br></br><br></br>
                    ...
                    <div className="form-group">
                        <label className="Heading">Phone Number:</label><br></br><br></br>
                        <input className="form-Task" placeholder="Contact Number" id="Task"
                            onChange={this.infoChange}
                            name="Task"
